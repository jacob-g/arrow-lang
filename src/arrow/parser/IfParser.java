...
import parser.tree.IfParseTreeNode;
import parser.tree.ParseTreeNode;

public class IfParser extends AbstractArrowParser {
	...
	public ParseResult<ArrowTokenType> parse(List<Token<ArrowTokenType>> tokens) {
		...
		return ParseResult.of(IfParseTreeNode.of(conditionNode, children), remainder);
	}
}
